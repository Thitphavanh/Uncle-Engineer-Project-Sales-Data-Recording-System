    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('sales', 'Sales'), ('account', 'Account'), ('admin', 'Admin')], default='sales', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slip_file', models.FileField(upload_to='slip_files/')),
                ('notes', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('confirmed', 'Confirmed')], default='pending', max_length=20)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.customuser')),
